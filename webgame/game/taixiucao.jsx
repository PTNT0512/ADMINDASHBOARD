...
const App = () => {
  ...
  useEffect(() => {
    ...
    socket.on('taixiucao', (data) => {
        ...
        if (phaseRef.current === 'SCRATCHING' && data.timeLeft < 15 && !isScratchedDone) {
           startResultPhase();
        }
    });
  ...
  }, [isDemoMode, session, isScratchedDone, dice]); // Bỏ phase khỏi dependency
