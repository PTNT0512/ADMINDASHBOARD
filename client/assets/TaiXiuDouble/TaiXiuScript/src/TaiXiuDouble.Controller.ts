    ...
    private checkShow() {
        ...
        if (this.isShowTX1) {
         //   this.taiXiu1.gamePlay.scale = 1;
            if (this.taiXiu1.gamePlay) this.taiXiu1.gamePlay.position = cc.Vec3.ZERO;
            if (this.taiXiu1.nodePanelChat) this.taiXiu1.nodePanelChat.active = true;
            if (this.taiXiu1.node) this.taiXiu1.node.setSiblingIndex(1);
         ...
         //   this.taiXiu1.gamePlay.scale = 0.5;
            if (this.taiXiu1.gamePlay) this.taiXiu1.gamePlay.position = cc.v3(-405, 234,0);
            if (this.taiXiu1.nodePanelChat) this.taiXiu1.nodePanelChat.active = false;
            if (this.taiXiu1.layoutBet) this.taiXiu1.layoutBet.active = false;
        }
    }
