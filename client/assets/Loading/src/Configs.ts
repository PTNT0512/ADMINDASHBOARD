...
namespace Configs {
    ...
    export class App {
        ...
        static API: string = "https://iportal.hit3s.fun/api";
		static API2: string = "https://iportal2.hit3s.fun/api";
		static APIROY: string = "https://portal.hit3s.fun/api";
        static API_PAYIN_PAYWELL_BANKS: string = "https://iportal.eloras.icu/api/payin/paywell/banks";
        static MONEY_TYPE = 1;
        static LINK_DOWNLOAD = "https://hit3s.fun/app/";
        static LINK_EVENT = "https://eloras.icu/event";
        static LINK_SUPPORT = "https://eloras.icu";
        static USE_WSS = false;
        static LINK_GROUP = "https://t.me/CSHKGOLD88";
        ...
        static readonly HOST_SOCKJS = "https://st.hit3s.fun/";
