...
namespace Lobby {
    ...
    export class LobbyController extends cc.Component {
        ...
        showAlertMiniGame() {
            ...
            let txtFormat = "<color=#ffffff>%s</c> " + App.instance.getTextLang('txt_congratualtion') + "<color=#ed5c02> %s </c>" + App.instance.getTextLang('txt_win') + "<color=#FF0000> %s</c>        ";
            ...
            this.scheduleOnce(() => {
                ...
                let acMove = cc.tween().by(1.0, { x: -39});
        ...
        actOpenMessager() {
            cc.sys.openURL("https://t.me/CSHKGOLD88");
        ...
        actOpenLive() {
            App.instance.openWebView("https://t.me/CSHKGOLD88");
        }
        ...
        actGameTaiXiuMd5() {
            ...
            MiniGameNetworkClient.getInstance().checkConnect(() => {
                App.instance.Showtaixiumd5(false);
        ...
        actSupportOnline() {
            ...
            if (!cc.sys.isNative) {
                var url = "https://t.me/CSHKGOLD88";
                cc.sys.openURL(url);
                //Tawk_API.toggle(https://t.me/CSHKGOLD88);
            }
            else {
                App.instance.openTelegram(Configs.App.getLinkTelegramGroup());
            }
            //App.instance.openTelegram("https://t.me/CSHKGOLD88");
        }
