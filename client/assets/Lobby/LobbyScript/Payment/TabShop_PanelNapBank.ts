...
export class TabShop_PanelNapBank extends BaseTabShop {
    ...
    // https://iportal.hit3s.fun/api?c=2002&nn=mrkenju66&at=397c67ce8ad778258d9622b54a173baa&pt=1&cp=R&cl=R&pf=web
    ...
    // https://iportal.hit3s.fun/api?c=130&cp=R&cl=R&pf=web&at=397c67ce8ad778258d9622b54a173baa
    ...
    // https://iportal.hit3s.fun/api?c=2003&fn=1&am=123123&pt=1&nn=mrkenju66&at=397c67ce8ad778258d9622b54a173baa&pn=manualbank&bc=Vietcombank&ds=mrkenju66&bn=123123&cp=R&cl=R&pf=web
        ...
        return {
            ...
            sendRequestCashIn : () => {
                ...
                Http.get(Configs.App.API, request, (err, res) => {
                    ...
                    //  cc.log(res);
                    if (res.success == true) {
						App.instance.ShowAlertDialog("Gửi yêu cầu nạp tiền thành công. Vui lòng đợi hệ thống xử lý!");
                        self.clearAll();
                    }else{
					App.instance.ShowAlertDialog(res.message);	
					}
