...
export default class MiniGameNetworkClient extends NetworkClient {
    ...
    protected onError(ev: Event) {
        ...
        cc.log("[MiniGameNetworkClient] error:", Configs.App.HOST_MINIGAME.host + ":" + Configs.App.HOST_MINIGAME.port);
    }
    ...
    protected onMessage(ev: MessageEvent) {
        ...
        switch (inpacket.getCmdId()) {
            case cmd.Code.LOGIN:
                this.isLogin = true;
                cc.log("[MiniGameNetworkClient] login success:", Configs.Login.Nickname);
