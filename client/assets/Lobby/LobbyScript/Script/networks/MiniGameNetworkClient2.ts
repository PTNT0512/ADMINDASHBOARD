...
export default class MiniGameNetworkClient2 extends NetworkClient {
    ...
    protected onError(ev: Event) {
        ...
        cc.log("[MiniGameNetworkClient2] error:", Configs.App.HOST_MINIGAME2.host + ":" + Configs.App.HOST_MINIGAME2.port);
    }
    ...
    protected onMessage(ev: MessageEvent) {
        ...
        switch (inpacket.getCmdId()) {
            case cmd.Code.LOGIN:
                this.isLogin = true;
                cc.log("[MiniGameNetworkClient2] login success:", Configs.Login.Nickname);
