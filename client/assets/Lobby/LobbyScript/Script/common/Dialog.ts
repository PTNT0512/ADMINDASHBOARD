...
export default class Dialog extends cc.Component {
    ...
    show(): void {
        ...
        TW(this.container)
            ...
            .to(0.3, { opacity: 255, scale: this.showScale }, { easing: cc.easing.backOut })
            .call(() => {
                this._onShowed();
            })
            .start();
    ...
    dismiss() {
        ...
        this.container.scale = this.showScale;
        TW(this.container).to(0.3, { scale: this.showScale * 0.8, opacity: 150 }, { easing: cc.easing.backIn })
            .call(() => {
                this._onDismissed();
            })
            .start();
