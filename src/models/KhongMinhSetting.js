...
const khongMinhSettingSchema = new mongoose.Schema({
  roomType: { type: String, default: 'khongminh' },
  botToken: String,
  groupId: String,
...
module.exports = mongoose.model('KhongMinhSetting', khongMinhSettingSchema);